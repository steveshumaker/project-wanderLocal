...
function AlternateSearchPage() {
  ...
  const rows = useSelector((store) => store.search);
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="right">{row.location_desc}</TableCell>
...
export default AlternateSearchPage;
